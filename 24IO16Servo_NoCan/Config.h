...
const uint8_t MCP_ADDRESSES[] = {  0x27, 0x21 };
#define NUM_MCP 1
#define NUM_MCP_PORTS 2   //// calc by hand - two each on two mcp23017s
...
#define MODEL BOARD "24IO16SVO" // The model of the board
#define HWVERSION "8NIO16MCP16Servo NoCan"          // Hardware version
